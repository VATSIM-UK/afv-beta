...
<p class="text-grey-darker text-base text-left">
    ...
    This means that you will only be able to see controllers and pilots who are part of the AFV testing program, and <u>will not be able to use AFV on the live VATSIM network</u>.<br />
</p>
...
<p class="text-grey-darker text-base text-left pb-2">	
