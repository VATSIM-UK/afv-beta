...
<p class="text-grey-darker text-base text-left">
    To use new voice as a vPilot user is very simple! Download the vPilot Beta from <a href="http://vpilot.metacraft.com/Assets/Files/Installers/AfvBeta/vPilotAFVBeta-Setup-2.2.2.7.exe">Here</a> and run the relevant vPilot (AFV Beta) Shortcuts.
